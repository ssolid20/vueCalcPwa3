    ...
    console.log(a)
      ...
      transform:function(val) {
       ...
       if (this.$store.state.addDeg===true){
            ...
            if (r.includes('sin(')) {r = r.replace('sin(' ,"sin( "); r = r.replace(/}/g,")")}
            if (r.includes('cos(')) {r = r.replace('cos(' ,"cos( "); r = r.replace(/}/g,")")}
            if (r.includes('tan(')) {r = r.replace('tan(' ,"tan( "); r = r.replace(/}/g,")")}
        ...
        if (r.includes('atan(deg')) {
                r = r.replace('atan(deg','atan(')
            }
        if (r.includes('asin(deg')) {
                r = r.replace('asin(deg','asin(')
            }
        if (r.includes('acos(deg')) {
                r = r.replace('acos(deg','acos(')
            }
        if (r.includes('π'))  {
            r = r.replace(/π/g,'pi')
            }
